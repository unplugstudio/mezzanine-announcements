...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Announcement.extra_content'
        db.add_column(u'announcements_announcement', 'extra_content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Announcement.extra_content'
        db.delete_column(u'announcements_announcement', 'extra_content')
    ...
    models = {
        ...
        u'pages.page': {
            ...
            u'extra_footer': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'featured_image': ('mezzanine.core.fields.FileField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            u'menu_content': ('mezzanine.core.fields.RichTextField', [], {'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'children'", 'null': 'True', 'to': u"orm['pages.Page']"}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'short_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'sidebar_content': ('mezzanine.core.fields.RichTextField', [], {'blank': 'True'}),
