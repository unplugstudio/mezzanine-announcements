...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Announcement.video_link'
        db.add_column(u'announcements_announcement', 'video_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Announcement.video_link'
        db.delete_column(u'announcements_announcement', 'video_link')
